...
#   @impl true
#   def init(_arg) do
#     Logger.info("[Email-Metrics] Starting Prometheus metrics exporter")

#     children = [
#       # Define metrics and start the Prometheus Core (metrics only, no HTTP)
#       {TelemetryMetricsPrometheus.Core, metrics: metrics(), name: :email_svc_metrics}
#     ]
...
#       Telemetry.Metrics.counter("email_svc.plug.stop.duration",
#         event_name: [:email_svc, :plug, :stop],
...
#       ),
#       Telemetry.Metrics.distribution("email_svc.plug.stop.duration",
#         event_name: [:email_svc, :plug, :stop],
#         measurement: :duration,
#         unit: {:native, :millisecond},
#         tags: [:route],
