...
#   @impl true
#   def init(_arg) do
#     Logger.info("[User-Metrics] Starting Prometheus metrics exporter")

#     children = [
#       # Define metrics and start the Prometheus Core (metrics only, no HTTP)
#       {TelemetryMetricsPrometheus.Core, metrics: metrics(), name: :user_svc_metrics}
#     ]
...
#       Telemetry.Metrics.counter("user_svc.plug.stop.duration",
#         event_name: [:user_svc, :plug, :stop],
...
#       ),
#       Telemetry.Metrics.distribution("user_svc.plug.stop.duration",
#         event_name: [:user_svc, :plug, :stop],
#         measurement: :duration,
#         unit: {:native, :millisecond},
#         tags: [:route],
