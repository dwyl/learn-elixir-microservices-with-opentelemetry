defmodule Mcsv.V2.EnqueueJobRequest.ArgsEntry do
  @moduledoc false
...
defmodule Mcsv.V2.EnqueueJobRequest do
  @moduledoc false
  ...
  field :args, 3, repeated: true, type: Mcsv.V2.EnqueueJobRequest.ArgsEntry, map: true
...
defmodule Mcsv.V2.EnqueueJobResponse do
  @moduledoc false
...
defmodule Mcsv.V2.GetJobStatusRequest do
  @moduledoc false
...
defmodule Mcsv.V2.JobStatusResponse.ArgsEntry do
  @moduledoc false
...
defmodule Mcsv.V2.JobStatusResponse do
  @moduledoc false
  ...
  field :args, 5, repeated: true, type: Mcsv.V2.JobStatusResponse.ArgsEntry, map: true
...
defmodule Mcsv.V2.ListJobsRequest do
  @moduledoc false
...
defmodule Mcsv.V2.CancelJobRequest do
  @moduledoc false
...
defmodule Mcsv.V2.CancelJobResponse do
  @moduledoc false
...
defmodule Mcsv.V2.RetryJobRequest do
  @moduledoc false
...
defmodule Mcsv.V2.RetryJobResponse do
  @moduledoc false
...
defmodule Mcsv.V2.GetQueueStatsRequest do
  @moduledoc false
...
defmodule Mcsv.V2.GetQueueStatsResponse.QueueStats do
  @moduledoc false
...
defmodule Mcsv.V2.GetQueueStatsResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :stats, 1, repeated: true, type: Mcsv.V2.GetQueueStatsResponse.QueueStats
end
