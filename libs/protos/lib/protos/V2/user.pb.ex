defmodule Mcsv.V2.EmailType do
  @moduledoc false
...
defmodule Mcsv.V2.UserRequest do
  @moduledoc false
  ...
  field :type, 4, type: Mcsv.V2.EmailType, enum: true
end

defmodule Mcsv.V2.UserResponse do
  @moduledoc false
...
defmodule Mcsv.V2.StoreImageRequest do
  @moduledoc false
...
defmodule Mcsv.V2.StoreImageResponse do
  @moduledoc false
...
defmodule Mcsv.V2.PdfReadyNotification do
  @moduledoc false
...
defmodule Mcsv.V2.PdfReadyResponse do
  @moduledoc false
...
defmodule Mcsv.V2.NotifyImageConvertedResponse do
  @moduledoc false
